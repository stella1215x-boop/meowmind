export const STAGE_CONFIG = [
  ...
  { stage: 1, label: 'Kitten',    minDays: 10 },
  { stage: 2, label: 'Playful',   minDays: 20 },
  { stage: 3, label: 'Adult',     minDays: 30 },
  { stage: 4, label: 'Wise',      minDays: 40 },
  { stage: 5, label: 'Legendary', minDays: 50 },
]

// Every 10 days of continuous writing = new stage
export const DAYS_PER_STAGE = 10
